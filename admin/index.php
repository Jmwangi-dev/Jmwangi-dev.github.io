        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'vacancies')? 'active' : '' ?>" href="./?page=vacancies">Vacancies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'applications')? 'active' : '' ?>" href="./?page=applications">Applicants</a>
                    </li>
